...
class AirCargoProblem(Problem):
    ...
    def actions(self, state: str) -> list:
        ...
        # extract current into boolean statuses
        current_pos = current_state.pos
        current_neg = current_state.neg

        def check_precond(action): # check if current state has satisfied the preconditions of this action
        ...
        possible_actions = [action for action in self.actions_list if check_precond(action)]
